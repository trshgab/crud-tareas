    ...
    <head>
        ...
        <style>
            ...
            /* ... (tu estilo actual) */
                ...
                /* Cambios de color y logo */
                .bg-red-50 {
                    --tw-bg-opacity: 1;
                    background-color: , rgb(30, 85, 152, var(--tw-bg-opacity)); /* Cambiar a tu tono de azul */
                }

                .stroke-red-500 {
                    stroke: #1E5598; /* Cambiar a tu tono de azul */
                }
                
                /* Cambiar el fondo del contenedor a tu tono de azul */
                .bg-dots-darker {
                    background-image: url("data:image/svg+xml,%3Csvg width='30' height='30' viewBox='0 0 30 30' fill='none' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath d='M1.22676 0C1.91374 0 2.45351 0.539773 2.45351 1.22676C2.45351 1.91374 1.91374 2.45351 1.22676 2.45351C0.539773 2.45351 0 1.91374 0 1.22676C0 0.539773 0.539773 0 1.22676 0Z' fill='rgba(0,0,0,0.07)'/%3E%3C/svg%3E");
                }

                .from-gray-700\/50 {
                    --tw-gradient-from: rgb(55, 65, 81, 0.5); /* Cambiar a tu tono de azul */
                }

                /* Cambiar el color del texto a tu tono de azul */
                .text-gray-600 {
                    --tw-text-opacity: 1;
                    color: rgb(17, 24, 39, var(--tw-text-opacity));
                }

                /* Cambiar el color del enlace a tu tono de azul y ajustar otros estilos si es necesario */
                .font-semibold {
                    font-weight: 600;
                    color: #1E5598; /* Cambiar a tu tono de azul */
                }
        </style>
    </head>
        ...
        <div class="relative sm:flex sm:justify-center sm:items-center min-h-screen bg-dots-darker bg-center bg-gray-100 selection:bg-red-500 selection:text-white">
            @if (Route::has('login'))
                <div class="sm:fixed sm:top-0 sm:right-0 p-6 text-right z-10">
                    @auth
                        <a href="{{ url('/dashboard') }}" class="font-semibold text-gray-600 hover:text-gray-900 focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">Tareas</a>
                    @else
            ...
            <div class="max-w-7xl mx-auto p-6 lg:p-8">
                <div class="flex justify-center">
                    <div class=>
                        <img src="{{ asset('images/logo_cos.png') }}" alt="Your Logo">
                    </div>
                </div>
                ...
                <div class="flex justify-center mt-16 px-0 sm:items-center sm:justify-between">
                    ...
                    {{-- <div class="flex justify-center">
                        <p class="text-lg font-bold text-center text-gray-500">Sistema de Gestión de Tareas</p>
                    </div> --}}
